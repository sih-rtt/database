...
export const seedCompletePg = async (numRecords: number) => {
  ...
  console.log(chalk.white('Completed job (3/3): ', chalk.bold('Seed CombinedRoute ', chalk.green('✅'))));
}
...
export const truncatePgTables = async () => {
  ...
  console.log(chalk.white('Completed job (1/4): ', chalk.bold('Truncate Conductor ', chalk.green('✅'))));
  ...
  console.log(chalk.white('Completed job (3/4): ', chalk.bold('Truncate BusRoute ', chalk.green('✅'))));
  await prisma.$executeRaw`TRUNCATE TABLE \"CombinedRoute\" CASCADE;`;
  console.log(chalk.white('Completed job (4/4): ', chalk.bold('Truncate BusRoute ', chalk.green('✅'))));
